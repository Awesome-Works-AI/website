    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          name: "Analiza danych",
          text: "Łączymy dane z twoich systemów i przepuszczamy przez AI: transkrypcje, oceny, trendy, raporty dobowe i miesięczne. Decyzje podejmujesz na liczbach, nie na przeczuciu.",
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          name: "Data analysis",
          text: "We connect data from your systems and run AI over it: transcripts, scoring, trends, daily and monthly reports. You decide on numbers, not gut feeling.",
