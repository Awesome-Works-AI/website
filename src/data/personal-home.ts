      ...
      items: [
        {
          ...
          tagline: "Rozmowa zamienia się w pierwszy scope.",
          title: "Rozmowy z klientem zamieniają się w pierwszy scope projektu, zamiast ginąć w notatkach.",
          description:
            "Łączy rozmowy, maile i notatki w jeden kontekst klienta — ustalenia, ryzyka i pytania trafiają wprost do dalszej pracy.",
          bullets: [
            "Łączy rozmowy, maile i notatki w jeden kontekst klienta.",
            "Wyciąga ustalenia, ryzyka i pytania do dalszej pracy z klientem.",
          ],
      ...
      items: [
        {
          ...
          name: "CallWise",
          label: "Lead intelligence",
          tagline: "Every call becomes the first scope.",
          title: "Client conversations become the first scope instead of getting lost in notes.",
          description:
            "Calls, emails, and notes become one client context layer — agreements, risks, and questions move into delivery faster.",
          bullets: [
