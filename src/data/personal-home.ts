    ...
    products: {
      ...
      items: [
        ...
        },
        {
          id: "metyra",
          name: "Metyra",
          label: "AI asystent CFO",
          title: "",
          description:
            "Zamienia rozproszone dane finansowe w decyzje, board packi i odpowiedzi dla mid-marketu.",
        ...
        },
        {
          ...
          title: "",
          description:
            "Jednoplikowy briefing newsowy generowany przez Twojego AI asystenta — bez kont, kluczy i deploya.",
    ...
    products: {
      ...
      items: [
        ...
        },
        {
          ...
          title: "",
          description:
            "Turns scattered finance data into decisions, board packs, and answers for mid-market teams.",
          logoSrc: "/metyra-logo.svg",
          logoAlt: "Metyra logo",
          href: metyraPath,
          cta: "See Metyra",
        ...
        },
        {
          ...
          title: "",
          description:
            "A single-file news briefing generated by your AI assistant — no accounts, keys, or deploy.",
          logoSrc: "/ai-daily-logo.svg",
          logoAlt: "AI Daily logo",
          href: aiDailyUrl,
